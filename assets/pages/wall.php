...
<div id="whole-container">
    ...
    <div class="main-Container">
        ...
        <div class="col-md-8 col-sm-12" style="max-width:70vw; margin-top:0rem;">
            ...
            if (count($posts) < 1) {
                echo "<p style='width:100%' class= 'p-2 text-center my-3 col-12'>No New Post</p>";
            }
            ...
            ?>
                ...
                <div style="border: 2px solid black ;" class="all-post card mt-4">
                    <div class="card-title d-flex justify-content-between  align-items-center">

                        <div class="d-flex align-items-center p-2">
                            <img src="assets/images/profile/<?= $post['profile_pic'] ?>" alt="" height="35" width="35" class="rounded-circle border">&nbsp;&nbsp;
            ...
            <div>
                ...
                ?>
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <button style="cursor: pointer; border:none;  padding:2px 10px; border-radius:50px; background:blue; color:white;" class=" text-light followbtn" data-user-id="<?= $suser['id']; ?>">Follow</button>
